// pemangkasan_page.dart

import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';
import 'detail_pemangkasan_page.dart';

class PemangkasanPage extends StatelessWidget {
  final String apiUrl = "http://127.0.0.1:8000/api/budidaya/pemangkasan";
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        DetailPemangkasanPage(data: data),
                                  ),
                                );
                              },
